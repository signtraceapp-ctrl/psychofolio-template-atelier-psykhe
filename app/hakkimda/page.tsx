      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl space-y-16">
            ...
            <div className="space-y-px border border-border/30">
              {c.about.credentials.map((cred, i) => (
                <div key={i} className="p-6 bg-bg-secondary/30 flex items-start gap-5">
                  <span className="text-[10px] tracking-[0.2em] uppercase text-primary/60 mt-1 flex-shrink-0 w-8">{String(i + 1).padStart(2, "0")}</span>
