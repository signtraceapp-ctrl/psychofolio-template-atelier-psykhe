        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl space-y-16">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <div className="flex items-center gap-3 border border-border/40 px-6 py-3 text-xs tracking-wider text-fg-muted">
            ...
            <div className="mx-auto max-w-md border border-border/30 bg-bg-secondary/20 p-8 space-y-6">
              ...
              <div className="text-center">
                <button type="button" disabled className="border border-primary/40 px-10 py-3 text-xs tracking-[0.15em] uppercase font-medium text-primary opacity-50 cursor-not-allowed">
